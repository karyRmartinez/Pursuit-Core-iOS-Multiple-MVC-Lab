...
""")
    ...
    //We want to go through this entire zooAnimals array and we want to make individual arrays that contain animals only of a specific classification. For example, we want to have an array that ONLY has mammals.
    ...
    static let allAnimals = [ZooAnimal.mammals, ZooAnimal.reptile, ZooAnimal.insect, ZooAnimal.bird]
    
}

extension ZooAnimal: imageble {
    var imageName: String {
        return String(imageNumber) // this makes a number into a string yayyy
    }
