//
//  ZooAnimalsListViewController.swift
//  AC-iOS-Multiple-MVC
//
...
class ZooAnimalsListViewController: UIViewController {
    @IBOutlet weak var tableView: UITableView!
    
    var zooAnimals: [ZooAnimalsListViewController] = []
...
extension ZooAnimalsListViewController: UITableViewDataSource, UITableViewDelegate {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let cell = tableView.dequeueReusableCell(withIdentifier: "zooAnimalCell") as! zooAnimalTableViewCell
        cell.setZooAnimals(image: image)
        return cell
    }
